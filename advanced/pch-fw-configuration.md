...
FIPS 140-2（Federal Information Processing Standard 140-2），联邦信息处理标准（FIPS）出版物 140-2 是美国政府标准，它定义了信息技术产品中加密模块的最低安全要求。该标准已被 FIPS 140-3（2019 年发布）取代，2026 年 9 月 21 日起 FIPS 140-2 认证将正式过渡为历史状态。
